...
public class CustomReport implements IReporter {
	...
	protected static class TestResult {
		...
		public TestResult(ITestContext context) {
			...
			failedTests = skippedTestDuplicateRemover(passedTests, failedTests);
			failedTests = skippedTestDuplicateRemover(skippedTests, failedTests);
	...
	/**
     * Removes Passed or Skipped Tests, and any duplicate Failed Tests from Failed Test List.
     * Duplicates may arise from retries.
     */
    protected static Set<ITestResult> skippedTestDuplicateRemover(Set<ITestResult> primaryList,
        Set<ITestResult> secondaryList) {

      Collection passedTestListNames = CollectionUtils.collect(primaryList, TransformerUtils
